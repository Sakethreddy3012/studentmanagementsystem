...
<div class="form-floating mb-3">
<input class="form-control" id="contact" name="contact" type="text" placeholder="1234567890" required pattern="[0-9]{12}" title="12 numeric characters only"  maxlength="12" required />
